# AdminAI – Részletes projektleírás

Ez a dokumentum az AdminAI technikai áttekintését adja: architektúra, adatbázis, Edge Functions, konvenciók és környezeti változók. Új fejlesztőknek és AI eszközöknek segít gyorsan belátni a rendszert.
...
**AdminAI** magyar hivatalos dokumentumok AI elemzésére szolgáló alkalmazás. Könyvelők és adminisztrátorok számára segíti a feltöltött dokumentumok strukturált feldolgozását, határidők és teendők nyomon követését, valamint keresést a tudásbázisban.
